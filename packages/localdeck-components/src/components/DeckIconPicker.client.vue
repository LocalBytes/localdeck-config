<template>
  <div class="dropdown-container">
    <div class="dropdown">
      ...
      <EmojiPicker
          :additionalGroups="{material:mdIconsGroups}"
          :native="true"
...
import type {ConfiguredButtonOptsLabel} from "@localbytes/localdeck-codegen/lib/virtuals/configured-button";
...
const onSelectEmoji = (emoji: EmojiExt) => {
  let MdIcon = emoji.n.find(s => s.startsWith('mdi:'));
