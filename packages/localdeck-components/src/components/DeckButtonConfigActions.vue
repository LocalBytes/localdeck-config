<template>
  <div class="p-2 gap-2 flex flex-col">
    ...
    <label class="flex gap-2">
      <input
        v-model="modelValue.component.blip_on_press"
    ...
    >
      <div class="flex flex-col gap-2">
        ...
        <label class="flex gap-2">
          <input
            v-model="modelValue.component.follow_state"
            :disabled="!modelValue.component.ha_entity"
            :checked="true"
            class="checkbox"
            type="checkbox"
        ...
        <label class="flex gap-2">
          <input
            v-model="modelValue.component.follow_brightness"
            :disabled="!modelValue.component.ha_entity || !modelValue.component.follow_state"
            :checked="true"
            class="checkbox"
            type="checkbox"
        ...
        <label class="flex gap-2">
          <input
            v-model="modelValue.component.follow_color"
            :disabled="!modelValue.component.ha_entity || !modelValue.component.follow_state"
            :checked="true"
            class="checkbox"
            type="checkbox"
